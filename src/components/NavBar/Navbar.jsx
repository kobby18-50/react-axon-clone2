...
const Navbar = () => {
  ...
  return (
    <>
      <div className={color ? "sm:hidden lg:flex navbar bg-transparent text-white fixed bg-black duration-500 pl-10 p-3" : "sm:hidden lg:flex navbar absolute bg-transparent text-white p-3"}>
